...
def main()->int:
    ap=argparse.ArgumentParser(prog='mosaic-registry');ap.add_argument('--version',action='version',version='mosaic-registry 0.1.3.5');sub=ap.add_subparsers(dest='cmd',required=True)
