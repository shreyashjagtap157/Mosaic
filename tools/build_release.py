...
def main()->int:
    ...
    for d in ['bin','lib','include','share/mosaic/packs/language','share/mosaic/packs/detector','share/mosaic/packs/lexer','share/mosaic','share/pkgconfig','docs','examples/authoring']:(stage/d).mkdir(parents=True,exist_ok=True)
