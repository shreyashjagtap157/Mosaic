...
def main()->int:
    ...
    for rel in ['bin/mosaic-tokenizer','bin/mosaic-author','lib/libmosaic.so','lib/libmosaic.a','lib/libmosaic_trust.so','lib/libmosaic_trust.a','include/mosaic.h','include/mosaic_trust.h']:manifest['artifacts'][rel]=sha(stage/rel)
