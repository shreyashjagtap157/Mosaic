...
def main()->int:
    ...
    (stage/'bin/mosaic-author').chmod(0o755);(stage/'bin/mosaic-registry').chmod(0o755);(stage/'bin/mosaicd').chmod(0o755)
    ...
    for rel in ['bin/mosaic-tokenizer','bin/mosaic-author','bin/mosaic-registry','bin/mosaicd','lib/libmosaic.so','lib/libmosaic.a','lib/libmosaic_trust.so','lib/libmosaic_trust.a','include/mosaic.h','include/mosaic_trust.h']:manifest['artifacts'][rel]=sha(stage/rel)
