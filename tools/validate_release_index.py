...
def main() -> int:
    ...
    require(text, "RELEASE_NOTES_0.1.3.2.md", "current release note link")
    require(text, "QUALIFICATION_0.1.3.2.md", "current qualification link")
    require(text, "QUALIFICATION_0.1.3.2_WINDOWS_PACKAGE.md", "windows package qualification link")
