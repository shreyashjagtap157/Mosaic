...
The native C ABI is independently versioned from the Mosaic product release. The current product candidate `0.1.1.0` continues to expose frozen C ABI `1.0.0`.
