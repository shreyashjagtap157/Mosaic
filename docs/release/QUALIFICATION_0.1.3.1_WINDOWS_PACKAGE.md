# Mosaic 0.1.3.1 Windows Package Qualification
...
- package validator `tools/validate_windows_package.py`: **PASS** when executed with the available local Python toolchain;
